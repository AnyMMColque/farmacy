...
document.addEventListener('DOMContentLoaded', function () {
  if (document.querySelector('#edit_mapa')) {
    ...
    var component = window.livewire.find('EhJ9mH4qGstb2YXdwQtn');
    var lat = component.get('lat');
    var lng = component.get('lng');
    console.log(lat);
    var edit_mapa = L.map('edit_mapa').setView([-19.5889474, -65.7529797], 17);
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
      attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
    }).addTo(edit_mapa);
