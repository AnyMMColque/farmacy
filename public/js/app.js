...
__webpack_require__(/*! ./mapedit */ "./resources/js/mapedit.js");

__webpack_require__(/*! ./dinamicMap */ "./resources/js/dinamicMap.js");
...
document.addEventListener('DOMContentLoaded', function () {
  Livewire.on('sendMap', function (lat, lng, id) {
    console.log(id);
    setTimeout(map, 500);

    function map() {
      if (document.querySelector('#' + id)) {
        var edit_mapa = L.map(id).setView([lat, lng], 17);
        ...
        marker = new L.marker([lat, lng], {
          draggable: true,
          autoPan: true
        }).addTo(edit_mapa); //Geocode service
        ...
        marker.on('moveend', function (e) {
          ...
          edit_mapa.panTo(new L.LatLng(position.lat, position.lng)); //Reverse Geocoding, where pin is placed
...
document.addEventListener('DOMContentLoaded', function () {
  if (document.querySelector('#mapa')) {
    ...
    var badSize = function badSize() {
      mapa.invalidateSize();
    };

    var badSize2 = function badSize2() {
...
document.addEventListener('DOMContentLoaded', function () {
  Livewire.on('sendLatitude', function (lat, lng, id) {
    // console.log(id)
    setTimeout(map, 500);
