...
<body class="font-sans antialiased">
    ...
    <!-- Footer -->
    <footer class="bg-green-100 dark:bg-gray-800 ">
            ...
            <div class="lg:flex">
                ...
                <div class="mt-6 lg:mt-0 lg:flex-1">
                    <div class="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4">
                        <div>
                            <h3 class="text-gray-700 uppercase dark:text-white">Farmacias Registradas</h3>
                            <a href="#"
                        ...
                        <div>
                            ...
                            <span class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">622-2111</span>
                            <span
                                class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">san.lorenzo@gmail.com</span>
                        </div>
                    </div>
                </div>
            </div>
