...
class InvoicesBetween implements FromCollection, WithHeadings, WithMapping
{
    /**
    ...
    */
    ...
    {
        return Invoice::whereBetween('date', [date("Y-m-d", strtotime($this->from)), date("Y-m-d", strtotime($this->to))])->get();
    }
}
