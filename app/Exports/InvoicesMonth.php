...
class InvoicesMonth implements FromCollection, WithHeadings, WithMapping
{
    /**
    ...
    */
    ...
    {
        return Invoice::whereBetween('date', [date("Y-m-d", strtotime(now() . "- 1 month")), date("Y-m-d", strtotime(now()))])->get();
    }
}
